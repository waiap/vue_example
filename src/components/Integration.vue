    ...
    <div class=container>
        <form>
            ...
            <div>
                ...
                <br>
                <span>Moneda seleccionada: {{ currency }}</span>
            </div>
            <br>
            ...
            <div>
                ...
                <input name=amount type="number" v-model="amount" id="amount" aria-describedby="amountHelp" placeholder="1" >
            </div>
            <button @click="$emit('checkout')">Comprar</button>
        </form>
    </div>
</template>
